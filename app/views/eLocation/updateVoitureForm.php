...
<head>
    ...
    <link rel="stylesheet" href="../app/views/eLocation/css/styles.css">
...
<body>
    ...
    ?>
        <div class="col-6 container p-2">
            <div class="border border-warning-subtle">
                <div class="bg-warning-subtle text-warning p-2">Modifier une voiture</div>
                <div class="p-3">
                    <form action="index.php?controller=eLocation&action=updateVoiture" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="prixLoc" placeholder="1234.56" class="form-control" maxlength="10">
                        </div><br>
                        <div class="form-group">
                            <label for="nbPortes">Nombre Portes</label>
                            <input list="nbPorte" name="nbPortes" class="form-control">
                            <datalist id="nbPorte" form-control>
