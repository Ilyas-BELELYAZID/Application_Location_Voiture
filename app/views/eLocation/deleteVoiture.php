            ...
            <div class="item-1">
                ...
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href=<?php if(isset($car)) echo "index.php?controller=eLocation&action=deleteVoiture&voiture=" . $car['idVoiture']; ?> class="btn btn-danger" onclick="return confirm('Voulez-vous supprimer cette voiture?');">Supprimer</a>
                  </div>
                </div>
              </div>
          </div>
